...
public class MyAdapter extends BaseExpandableListAdapter{
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (groupPosition == 0) {
            ((ImageView) convertView.findViewById(R.id.image2)).setImageResource(R.drawable.ic_action_record);
            //((TextView) convertView.findViewById(R.id.text2)).setText(parent.getResources().getString(R.string.s_captura));
        } else if (groupPosition == 1) {
            ((ImageView) convertView.findViewById(R.id.image2)).setImageResource(R.drawable.ic_action_database);
            //((TextView) convertView.findViewById(R.id.text2)).setText(parent.getResources().getString(R.string.s_datos));
        } else if (groupPosition == 2) {
            ((ImageView) convertView.findViewById(R.id.image2)).setImageResource(R.drawable.ic_action_settings);
            //((TextView) convertView.findViewById(R.id.text2)).setText("");
        } else if (groupPosition == 3) {
            ((ImageView) convertView.findViewById(R.id.image2)).setImageResource(R.drawable.ic_action_help);
        ...
        switch (groupPosition){
            ...
            case 0:
                switch (childPosition){
                    case 0:
                        ((ImageView) convertView.findViewById(R.id.img_hijo)).setImageResource(R.drawable.ic_action_video);
                        break;
                    case 1:
                        ((ImageView) convertView.findViewById(R.id.img_hijo)).setImageResource(R.drawable.ic_signal_camara);
                        break;
                    case 2:
                        ((ImageView) convertView.findViewById(R.id.img_hijo)).setImageResource(R.drawable.ic_signal_camara);
                        break;
                    case 3:
                        ((ImageView) convertView.findViewById(R.id.img_hijo)).setImageResource(R.drawable.ic_action_phone);
                        break;
                }
                break;
            case 2:
                switch (childPosition){
                    case 0:
                        ((ImageView) convertView.findViewById(R.id.img_hijo)).setImageResource(R.drawable.ic_action_gear);
                        break;
                    case 1:
                        ((ImageView) convertView.findViewById(R.id.img_hijo)).setImageResource(R.drawable.ic_action_bargraph);
                        break;
                    case 2:
                        ((ImageView) convertView.findViewById(R.id.img_hijo)).setImageResource(R.drawable.ic_action_signal);
                        break;
                }
                break;
            case 3:
                switch (childPosition){
                    case 0:
                        ((ImageView) convertView.findViewById(R.id.img_hijo)).setImageResource(R.drawable.ic_action_book);
                        break;
                    case 1:
                        ((ImageView) convertView.findViewById(R.id.img_hijo)).setImageResource(R.drawable.ic_action_user);
                        break;
                    case 2:
                        ((ImageView) convertView.findViewById(R.id.img_hijo)).setImageResource(R.drawable.ic_action_info);
                        break;
                }
                break;
